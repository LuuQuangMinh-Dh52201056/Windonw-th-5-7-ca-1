...
namespace WpfApp1.Migrations
{
    ...
    [Migration("20260205010738_buoi3")]
    partial class buoi3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WpfApp1.Models.Chitiethoadon", b =>
                {
            ...
            modelBuilder.Entity("WpfApp1.Models.Hanghoa", b =>
                {
                    b.Property<string>("Mahang")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WpfApp1.Models.Hoadon", b =>
                {
                    b.Property<string>("Sohd")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WpfApp1.Models.Chitiethoadon", b =>
                {
                    b.HasOne("WpfApp1.Models.Hanghoa", "MahangNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Mahang")
                        .IsRequired()
                        .HasConstraintName("FK_chitiethoadon_hanghoa");

                    b.HasOne("WpfApp1.Models.Hoadon", "SohdNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Sohd")
                        .IsRequired()
